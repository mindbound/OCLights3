...
import opengpu.jhlabs.image.BoxBlurFilter;
...
public class Texture {
	...
	public Texture(int w, int h)
	{
		...
		{
			try {
			font = ImageIO.read(OpenGPU.class.getResourceAsStream("/assets/oclights/textures/gui/ascii.png"));
	        ...
	        while (i1 < 256)
	        {
				...
				OpenGPU.debug("failed to load typeface for oclights2 ;_; did you mess with the files?");
			}
		}
	...
	public void drawTexture(Texture tex, int x, int y, Color c)
	{
		if (tex == null)
		{
			OpenGPU.debug("Texture to draw is null.");
			return;
		}
	...
	protected void finalize() throws Throwable {
		OpenGPU.debug("Texture is being discarded...");
		dispose();
	}
