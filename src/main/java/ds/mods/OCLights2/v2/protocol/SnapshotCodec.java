...
import ds.mods.OCLights2.v2.scene.SceneCanvas;
import ds.mods.OCLights2.v2.scene.SceneNode;
		...
		try {
			...
			for (int i = 0; i < resCount; i++) {
				...
				if (type == V2Wire.RES_CANVAS) {
					int cap = in.readInt();
					ArrayList<ds.mods.OCLights2.v2.scene.CanvasCommand> commands = BatchCodec.readCommands(in);
