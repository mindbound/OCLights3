...
| Doc | What's in it |
|---|---|
| [PROJECT.md](PROJECT.md) | Charter: what OpenGPU is, lineage, goals, open questions |
...
producing `build/libs/OpenGPU-mc1.7.10-<git-describe>[-dev|-sources].jar`. FPGradle 4.0.2 is
