...
import ds.mods.OCLights2.v2.persist.ScenePersistence;
...
public class ScenePersistenceTest {
	...
	public void missingBodyDegradesToBlankWithWarningAndFreshEpoch() throws Exception {
		...
		ds.mods.OCLights2.v2.scene.ResourceInfo texture = result.scene.state().resources.get(2);
	...
	public void corruptStructureThrowsCodecExceptionOnly() throws Exception {
		...
		} catch (ds.mods.OCLights2.v2.protocol.CodecException expected) {
		}
